(function(root,factory){
  ...
  const APP_NAME='guitar-diary', BACKUP_VERSION=1;
  ...
  return {APP_NAME,BACKUP_VERSION,createBackup,serializeBackup,parseBackupText,getFileName,replaceStorageAtomically};
});
